...
$(document).ready(function () {
    ...
    $(window).scroll(function () {
        ...
        if ($(window).scrollTop() > 80) {
            ...
            $(".navbar-brand img").css({'padding-top': '20px'});
...
$(document).ready(function () {
    ...
    $("#owl-demo").owlCarousel({
        autoPlay: 3000, items: 4, //10 items above 1000px browser width
        itemsDesktop: [
            1370, 3
...
$(document).ready(function () {
    ...
    $('#mc-form').ajaxChimp({
        ...
        url: "https://themerocks.us9.list-manage.com/subscribe/post?u=f04c804868966b1b4509daa9" +
                "b&amp;id=ad7b6aba65"
    });
    ...
    function mailchimpCallback(resp) {
        ...
        if (resp.result === 'success') {
            $('.subscription-success')
                .html('<i class="pe-7s-check"></i><br/>' + resp.msg)
                .fadeIn(1000);
            $('.subscription-error').fadeOut(500);
        } else if (resp.result === 'error') {
            $('.subscription-error')
                .html('<i class="pe-7s-close-circle"></i><br/>' + resp.msg)
                .fadeIn(1000);
        }
    }
});
