...
//        console.log('Event: ', e.target.value);        
        ...
        var list = this.state.list_packages.filter((value) => {
            return value.description.toLowerCase().match(this.state.text_search) 
            || value.name.toLowerCase().match(this.state.text_search);
        });
                        ...
                        <footer className="applicationFooter">
                            <div className="footer-row">
                                <section className="about">
                                    ...
                                    <a href="https://twitter.com/anlijudavid" className="twitter-follow-button" data-show-count="false">Follow @anlijudavid</a>
