...
/***/ function(module, exports, __webpack_require__) {
	...
	var Index = function (_Component) {
	  ...
	  (0, _createClass3.default)(Index, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      var actions_buscar = this.props.actions_buscar;

	      // Semilleros

	      actions_buscar.listar().then(function () {
	...
	function mapDispatchToProps(dispatch) {
	  return {
	    actions_buscar: (0, _redux.bindActionCreators)(BuscarActions, dispatch)
	  };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// REQUEST ROLES:
	function buscar_request(response) {
	  return function (dispatch) {
	    dispatch({
	      response: response,
	      type: _buscar.LISTAR_BUSQUEDA
	    });
	  };
	}
	...
	function listar() {
	  return function (dispatch) {
	    return _axios2.default.get('https://www.npmjs.com/profile/types/packages').then(function (response) {
